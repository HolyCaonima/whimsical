...
HE.detailOrder=function(value,component){
    var order={transform:['position','rotation','scale','parent'],render:['mesh','material','visible','castShadow'],light:['type','color','intensity'],collider:['enabled','shape']}[component]||[];
